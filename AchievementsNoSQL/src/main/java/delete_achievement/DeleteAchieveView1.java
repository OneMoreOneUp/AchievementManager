...
public final class DeleteAchieveView1 extends JFrame implements DeleteAchieveView {
     ...
     * events.
     */
    private DeleteAchieveController controller;
     ...
     * Default constructor.
     */
    public DeleteAchieveView1(AchieveSettings settings, String category, String title) {
         ...
         */
        super("Delete Achievement: " + title + "?");
        ...
        this.lAsk = new JLabel("Are you sure you want to delete: " + title + "?");
    ...
    @Override
    public void registerObserver(DeleteAchieveController controller) {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (source == this.bYes) {
            this.controller.processYesEvent(this.settings, this.category, this.title);
        } else {
