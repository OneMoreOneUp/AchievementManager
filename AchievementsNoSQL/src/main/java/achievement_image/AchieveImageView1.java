...
public final class AchieveImageView1 extends JFrame implements AchieveImageView {
     ...
     * events.
     */
    private AchieveImageController controller;

    /**
     * JComponents
     */
    private final JLabel lTitle, lCategory, lImage;
    private final JTextField tTitle, tCategory;
    private final JTextArea tNote;
    private final JButton bUploadImage, bDeleteImage, bUpload, bBack;

    /**
     * Default constructor.
     */
    public AchieveImageView1(AchieveSettings settings, String title, String category) {
         ...
         */
        super("Image Upload: " + category + ": " + title);
        ...
        //Text fields
        this.tTitle = new JTextField(title);
        this.tCategory = new JTextField(category);
        this.tTitle.setEditable(false);
        this.tCategory.setEditable(false);
    	...
    	mainPanel.add(this.bUpload, mainConstraints);
    ...
    @Override
    public void registerObserver(AchieveImageController controller) {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (source == this.bUploadImage) {
        	...
        	this.resetImage();
        } else if (source == this.bUpload) {
        	this.controller.processUploadEvent(settings, this.title, this.category, this.imageURL, this.image);
        } else {
